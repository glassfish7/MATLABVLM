function [mainControlPointsY,mainControlPointsX,mainQuarterC,mainPanelGeomY,mainPanelGeomX,mainVControlPointsX,Stot,span,Npanels,K] = geomEngine(sections,data,bPanelsL,cPanels)
