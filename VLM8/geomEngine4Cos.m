function [mainControlPointsY,mainControlPointsX,mainQuarterC,maintquarterPointsX,mainPanelGeomY,mainPanelGeomX,mainVControlPointsX,Stot,span,Npanels,K,CAve,chordDistGeom,chordDistCont] = geomEngine4(sections,data,bPanelsL,cPanels,plotCont)
...
% rootChordPoints = flip(rootChordPoints);
% tipChordPoints = flip(tipChordPoints);
...
%             if j == 1
%                 tquarterPointsX(j,i) = panelGeomX(j,i) + (panelGeomX(j+1,i)-panelGeomX(j,i))/2;
%             else
