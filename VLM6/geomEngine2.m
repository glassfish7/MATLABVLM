function [mainControlPointsY,mainControlPointsX,mainQuarterC,mainPanelGeomY,mainPanelGeomX,mainVControlPointsX,Stot,span,Npanels,K,CAve,chordDistGeom,chordDistCont] = geomEngine2(sections,data,bPanelsL,cPanels,plotCont)
