function [] = drawSim(mainControlPointsY,mainControlPointsX,mainQuarterC,mainPanelGeomY,mainPanelGeomX,alpha,beta,wakeT,xw,yw,zw,time,bPanels,cPanels,mode,anim)
