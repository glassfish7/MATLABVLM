function [controlPointsY,controlPointsX,panelQuarterC,panelQuarterCX,tquarterPointsX,panelGeomY,panelGeomX,vControlPointsX,VcontrolPointsY,Stot,span,Npanels,K,CAve,chordDistGeom,chordDistCont] = geomEngine3Conc(~,data,bPanelsL,cPanels,plotCont)
